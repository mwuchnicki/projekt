...
<head>
    ...
    <title>Projekt PARMODE - Etap 1</title>
...
<body>
        ...
        <div class="container">
           ...
           <div class="left-sidebar">
            ...
            <form id="sampleForm" name="sampleForm" action="etap1.php" method="post"> 
...
var pytanie<?php echo $stan_licznika+1; ?>_punkty = new L.WFST({
    ...
    typeName: "...", // w miejsce ... wstawić nazwę warstwy z serwisu Geoserver
    crs: L.CRS.EPSG4326,
