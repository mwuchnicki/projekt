...
?>
        ...
        <div class="container">
           ...
           <div class="left-sidebar">
            <h2>ETAP PIERWSZY</h2>
            <p class="question">Proszę zaznaczyć na mapie miejsce swojego aktualnego zamieszkania (proszę zaznaczyć tylko w jeden sposób).</p>
 ...
 -->        <button class="button1" onclick="drawPoint()">Dodaj punkt</button>
            ...
            <br>
            <p class="question">Proszę zaznaczyć na mapie Stary Rynek w Poznaniu (proszę zaznaczyć tylko w jeden sposób).</p>
            <!--             nowe przyciski ostylowane w css
 -->        <button class="button1" onclick="drawPoint()">Dodaj punkt</button>
            <button class="button1" onclick="drawPolygon()">Dodaj poligon</button>
    ...
    popup
      ...
      .openOn(map);
        ...
        map.on('draw:created', function(event) {
            ...
            var content = '<input type="button" id="okBtn" value="Zapisz obiekt" onclick="saveData()"> </input><input type="button" id="okBtn" value="Anuluj" onclick="window.history.go()"/>';
